...
export const questions: Question[] = [
    ...
    {
        "id": 7,
        "text": "\"오른쪽 그림과 같은 정육면체의 부피가 $\\sqrt{3}$ 일 때, 삼각형 AFC 의 넓 이는 $\\frac{\\sqrt{3^m}}{2}$ 이다. 이때 서로소인 두 자연수 $m, n$ 에 대하여 $m+n$ 의 값 을 구하시오. (단, $n \\geq 2$ )\"",
        "options": [
            "11",
            "13",
            "3",
    ...
    {
        "id": 25,
        "text": "전체집합 \(U=\{x \mid x \text{는 } 100 \text{ 이하의 자연수}\}\)의 두 부분집합 \(A, B\)가

$$
\begin{aligned}
& A=\left\{x \mid \log_2 x \text{가 자연수인 } x \in U\right\}, \\
...
일 때, 집합 \(A \cup B\)의 원소의 개수는?",
    ...
    {
        "id": 38,
        "text": "\"양수 $x$ 에 대하여\n\n$$\n\\log _3 x=f(x)+g(x) \\quad(f(x) \\text { 는 정수, } 0 \\leq g(x)<1)\n$$\n\n\n라 할 때,\n\n$$\n\\begin{aligned}\n& 1 \\cdot 3^{q(1)-f(1)}+2 \\cdot 3^{q\\left(\\frac{1}{2}\\right)-f\\left(\\frac{1}{2}\\right)}+3 \\cdot 3^{q\\left(\\frac{1}{3}\\right)-f\\left(\\frac{1}{3}\\right)} \\\n& +4 \\cdot 3^{q\\left(\\frac{1}{4}\\right)-f\\left(\\frac{1}{4}\\right)}+5 \\cdot 3^{q\\left(\\frac{1}{5}\\right)-f\\left(\\frac{1}{5}\\right)}\n\\end{aligned}\n$$\n\n\n의 값을 구하시오.\"",
        "options": [
            "181",
            "100",
            "262",
    ...
    {
        "id": 72,
        "text": "\"두 집합\n\n$$\n\\begin{aligned}\n& A=\\left\\{x \\mid 3^{x(x-2)} \\leq 3^{2 x-3}\\right\\}, \\\n& B=\\left\\{x \\mid \\log _2\\left(x^2+a x+b\\right) \\leq \\log _2 2 x\\right\\}\n\\end{aligned}\n$$\n\n\n가 서로 같을 때, 상수 $a, b$ 에 대하여 $a b$ 의 값을 구하시오.\n(다, $a^2<4 b$ )\"",
        "options": [
            "-6",
            "6",
            "-3",
    ...
    {
        "id": 73,
        "text": "\"연립방정식\n\n$$\n\\left\\{\\begin{array}{l}\n\\log _2 x+\\log _3 y=6 \\\n\\log _3 x \\cdot \\log _2 y=8\n\\end{array}\\right.\n$$\n\n\n의 해가 $x=\\alpha, y=\\beta$ 일 때, $\\alpha+\\beta$ 의 값을 구하시오 (다, $\\alpha>\\beta)$\"",
        "options": [
            "25",
            "17",
            "19",
