...
export const questions: Question[] = [
    ...
    {
        "id": 42,
        "text": "함수 $f(x)=a^x(a>0, a \\neq 1)$ 에 대하여 $f(2)=\\frac{1}{9}$ 일 때, $y=f(x)$ 에 대한 설명으로 옳은 것만을 [보기]에서 있는 대로 고른 것은?<br />ㄱ. $f(-4)=16$ <br />ㄴ. 그래프는 점 $(-1,3)$을 지난다.<br />ㄷ. 그래프의 점근선은 $x$축이다.<br />ㄹ. $x$의 값이 증가하면 $y$의 값도 증가한다.",
        "options": ["$$\\text{ㄱ,ㄴ}$$", "$$\\text{ㄱ,ㄷ}$$", "$$\\text{ㄱ,ㄹ}$$", "$$\\text{ㄴ,ㄷ}$$", "$$\\text{ㄷ,ㄹ}$$"],
        "correctAnswer": 1,
        "difficulty": 1,
        "concept": 2,
        "hasImage": false,
    ...
    {
        "id": 47,
        "text": "$0<a<1$ 일 때, 세 수 $a, a^a, a^{a^a}$ 의 대소 관계는?",
    ...
    {
        "id": 64,
        "text": "정의역이 $\\left\\{x \\mid-1 \\leq x \\leq 2 \\right\\}$ 인 함수 $y=\\log _2\\left(-x^2+2 x+7\\right)$ 의 최댓값과 최솟값의 곱은?",
        "options": ["$$ 6 $$", "$$ 2 $$", "$$ 4 $$", "$$ 8 $$", "$$ 10 $$"],
        "correctAnswer": 1,
        "difficulty": 1,
        "concept": 4,
    ...
    {
        "id": 73,
        "text": "연립방정식 $\\log _2 x + \\log _3 y = 6$, $\\log _3 x \\cdot \\log _2 y = 8$ 의 해가 $x = \\alpha$, $y = \\beta$ 일 때, $\\alpha + \\beta$ 의 값을 구하시오 (단, $\\alpha > \\beta$)",
